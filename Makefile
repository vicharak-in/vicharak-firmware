...
.PHONY: deb
deb: debian
	debuild --no-lintian --lintian-hook "lintian --suppress-tags bad-distribution-in-changes-file --suppress-tags non-standard-toplevel-dir -- %p_%v_*.changes" --no-sign -b
